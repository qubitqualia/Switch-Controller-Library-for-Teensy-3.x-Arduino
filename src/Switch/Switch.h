...
class Switch {
	...
	public:
		...
		/*---------------------------------------------
		 * Set stopwatch_interval alarm for SPST switch
		 * --------------------------------------------
		 * ARGUMENTS:
		 * mils = Alarm interval in millis
		 * on_time = Time to kee switch ON in millis
		 *
		 * Function can only be called for SPST switches!
		 * Sets the time interval for a stopwatch alarm that has been added to a SPST
		 * switch using `addAlarm(SwitchAlarm::Stopwatch_Interval)`
		 */
		void setAlarm(int mils, int on_time);
		static void _setAlarm(std::string sw_name, int mils, int on_time);

		/*------------------------------------------
		 * Set stopwatch_clock alarm for SPST switch
		 * -----------------------------------------
		 * ARGUMENTS:
		 * clock_time = Clock time for alarm - "HH:mm:ss" in 24-hour format
		 * on_time = Time to keep switch ON in millis
		 *
		 * Function can only be called for SPST switches!
		 * Sets the clock time for a stopwatch alarm that has been added to a SPST
		 * switch using `addAlarm(SwitchAlarm::Stopwatch_Clock)`
		 */
		void setAlarm(std::string clock_time, int on_time);
		static void _setAlarm(std::string sw_name, std::string clock_time, int on_time);
		 ...
		 * switch using `addAlarm(SwitchAlarm::Toggler)`
		 */
		...
		/*-------------------------------------------------
		 * Set stopwatch_interval alarm for any switch type
		 * ------------------------------------------------
		 * ARGUMENTS:
		 * pos = Position number (0, 1, 2)
		 * mils = Alarm interval in millis
		 ...
		 * switch position using `addAlarm(SwitchType::Stopwatch_Interval)`
		 */
		...
		/*-----------------------------------------------------
		 * Set stopwatch_clock alarm for any switch type
		 * ----------------------------------------------------
		 * ARGUMENTS:
		 * pos_name = Position name
		 * clock_time = Clock time for alarm - "HH:mm:ss" in 24-hour format
		 ...
		 *
		 * Function can be called for SPST, SPDT and SP3T switches.
		 * Sets the clock time for a stopwatch alarm that has been added to a
		 * switch position using `addAlarm(SwitchType::Stopwatch_Clock)`
		 */
		void setAlarm(std::string pos_name, std::string clock_time, int on_time);
		static void _setAlarm(std::string sw_name, std::string pos_name, std::string clock_time, int on_time);
		 ...
		 * Overloaded version accepts position number as argument
		 */
		void setAlarm(int pos, std::string clock_time, int on_time);
		static void _setAlarm(std::string sw_name, int pos, std::string clock_time, int on_time);
	...
	private:
		...
		static bool isDormant( Position* pos);
		...
		static void setAlarm(Switch* _switch, std::string clock_time, int on_time);
		static void setAlarm(Switch* _switch, std::string pos_name, std::string clock_time, int on_time);
		static void setAlarm(Switch* _switch, int pos, std::string clock_time, int on_time);
